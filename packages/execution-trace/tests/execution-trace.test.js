...
function testDomainRestrictions() {
  ...
  assert.equal(
    isEventAllowedForDomain(EVENT_TYPES.HEAP_INSERT, TRACE_DOMAINS.PROGRAM),
    true
  );

  assert.equal(
    isEventAllowedForDomain(EVENT_TYPES.HEAP_INSERT, TRACE_DOMAINS.QUERY),
    false
  );
  ...
  assert.equal(
    isEventAllowedForDomain(EVENT_TYPES.SEARCH_COMPARE, TRACE_DOMAINS.PROGRAM),
    true
  );

  assert.equal(
    isEventAllowedForDomain(EVENT_TYPES.SEARCH_COMPARE, TRACE_DOMAINS.QUERY),
    false
  );

  assert.equal(
    isEventAllowedForDomain(EVENT_TYPES.SORT_COMPARE, TRACE_DOMAINS.PROGRAM),
    true
  );

  assert.equal(
    isEventAllowedForDomain(EVENT_TYPES.SORT_SWAP, TRACE_DOMAINS.QUERY),
    false
  );
